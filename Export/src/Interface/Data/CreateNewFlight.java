...
//    }
    ...
    public CreateNewFlight(JPanel userProcessContainer, Enterprise enterprise, Network network){
       initComponents();
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        enterprise.getDatastore().getFliList().add(new Flight(flight.getFlightnumber(),flight.getCty(),flight.getCapacity(),flight.getPrice()));
        network.getNetworkDataStore().getFliList().add(new Flight(flight.getFlightnumber(),flight.getCty(),flight.getCapacity(),flight.getPrice()));
